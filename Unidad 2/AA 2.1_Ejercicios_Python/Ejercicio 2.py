# Objetivo: Uso de tipos de datos
# Ejercicio 2: prueba cada uno de los siguientes ejercicios
...
print('¿El primer número es diferente al segundo?: ', num1 != num2)
