# Ejercicio 9: programa que realizara la selección del estudiandte de acuerdo a sus respuestas

# Sombrerero seleccionador 🧙‍♂️
...
"""
Flujo del programa
1. Imprime el título del sombrero Seleccionado.
"""

print('==================')
print('El sombrerero seleccionador 🧙‍♂️')
print('==================')
...
respuesta = int(input('Ingrese respuesta (1-2): '))
...
print('\nP3) ¿Qué tipo de instrumento complace más a tu aído?: ')
...
Resultados:
    ...
    - Imprime los punts acumulados para cada casa
    - Anuncia la cassa a la que el usuario ha sido asignado, basada en los puntos acumulados
"""

print('Gryffindow: ', gryffindor)
